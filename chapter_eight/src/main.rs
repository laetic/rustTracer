...
fn main() -> std::io::Result<()> {
    ...
    let lambert_one = Lambertian{albedo: Vec3::new(0.8, 0.3, 0.3)};
    let lambert_two = Lambertian{albedo: Vec3::new(0.8, 0.8, 0.0)};
    let metal_one = Metal{albedo: Vec3::new(0.8, 0.6, 0.2)};
    let metal_two = Metal{albedo: Vec3::new(0.8, 0.8, 0.8)};

    let e_mat_lamb = material::EMat::Lambertian{albedo: Vec3::new(0.8, 0.3, 0.3)};
    let e_mat_lamb_two = material::EMat::Lambertian{albedo: Vec3::new(0.8, 0.8, 0.0)};
